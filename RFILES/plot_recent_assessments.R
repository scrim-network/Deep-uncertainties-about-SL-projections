...
# Splitt dataset 66% projections for which also 90% is available (Kopp and Grinsted)
...
# set colors
#projection.colors <- c("deepskyblue", "darkblue", "red", "green2", "green4", "magenta", "purple", "orange")
